import { factionGuides, factionSides, factionCheckedAt, factionAimTargets, factionTactics, factionApproaches } from './faction-data.js?v=weapons-only-1';
...
import { factionLoadouts } from './faction-loadouts.js?v=weapons-only-1';
import { factionGuideEnemies } from './faction-data.js?v=weapons-only-1';
